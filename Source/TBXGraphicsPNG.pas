...
type
  ...
  protected
    ...
    procedure WriteChunk(Stream: TStream; const ChunkType: AnsiString; const Data; DataLength: Cardinal);
...
begin
  ...
  try
    ...
    repeat
      ...
      Stream.Seek(FHeader.Length + 4, soCurrent);
...
procedure TPNGWriter.WriteChunk(Stream: TStream; const ChunkType: AnsiString; const Data; DataLength: Cardinal);
var
  Hdr: TPNGChunkHeader;
  CRC: Cardinal;
begin
