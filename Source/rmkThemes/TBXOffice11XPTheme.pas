...
//
// Office11XPtheme ©2004 Roy Magne Klever
...
begin
  ...
  begin
    ...
    begin
      ...
      //FillGradient(Canvas.Handle, R, gradCol1, gradCol2, TGTopBottom); // rmkB
      InflateRect(R, -2, 0);
...
begin
  ...
  begin
    ...
    begin
      ...
      FillGradient(Canvas, R, GetBtnColor(ItemInfo, ipBody), gradCol2,
        TGTopBottom);
      //FillGradient(Canvas.Handle, R, GetBtnColor(ItemInfo, ipBody), gradCol2, TGTopBottom);
    end;
  end;
end;
...
procedure TTBXOffice11XPTheme.TBXSysCommand(var Message: TMessage);
begin
